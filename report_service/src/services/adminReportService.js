...
class AdminReportService {
     ...
     * @param {Object} businessData - Datos completos del emprendimiento enviados por Kafka
     */
    async generateBusinessReport(businessData) {
        try {
            logger.info('Generando reporte administrativo de emprendimiento');

            // Generar HTML del reporte
            const html = this.generateReportHTML(businessData);
            ...
            logger.info('Reporte administrativo generado exitosamente');
            return pdf;

        } catch (error) {
            logger.error('Error generando reporte para administrador:', error);
            throw error;
        }
    }
