...
class ComparativeReportService {
     ...
     * @param {Array} businesses - Array de emprendimientos enviados por Kafka
     * @param {Object} filters - Filtros aplicados (opcional)
     */
    async generateComparativePDF(businesses, filters = {}) {
        try {
            logger.info(`Generando reporte comparativo PDF de ${businesses.length} emprendimientos`);
            ...
            logger.info('Reporte comparativo PDF generado exitosamente');
            return pdf;

        } catch (error) {
            logger.error('Error generando reporte comparativo PDF:', error);
            throw error;
        }
    }
     ...
     * @param {Object} filters - Filtros aplicados (opcional)
     */
    async generateComparativeExcel(businesses, filters = {}) {
        try {
            logger.info(`Generando reporte comparativo Excel de ${businesses.length} emprendimientos`);
            ...
            logger.info('Reporte comparativo Excel generado exitosamente');
            return buffer;

        } catch (error) {
            logger.error('Error generando reporte comparativo Excel:', error);
            throw error;
        }
    }
