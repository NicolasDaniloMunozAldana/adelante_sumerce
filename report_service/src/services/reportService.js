...
class ReportService {
    ...
    async generateBusinessReport(businessData) {
        try {
            logger.info('Generando reporte de emprendimiento para usuario');
            ...
            logger.info('Reporte de emprendimiento generado exitosamente');
            return pdf;

        } catch (error) {
            logger.error('Error generando reporte de emprendimiento:', error);
            throw error;
        }
    }
